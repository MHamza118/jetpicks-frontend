...
const SupportButton = () => {
    ...
    return (
        <button
            ...
            className={`fixed bottom-20 right-3 sm:bottom-24 sm:right-4 md:bottom-28 md:right-5 lg:bottom-32 lg:right-6 ${buttonColor} ${buttonTextColor} rounded-full p-2.5 sm:p-3 md:p-3.5 lg:p-4 shadow-lg transition-all duration-300 hover:scale-110 z-40 flex items-center gap-0.5 sm:gap-1 md:gap-1.5 lg:gap-2 group`}
