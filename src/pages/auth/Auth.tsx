...
import { facebookAuthApi } from "../../services/facebookAuth";
...
const Auth = () => {
  ...
  const loadFacebookSdk = () => {
    ...
    if (existingScript) {
      // SDK already injected; initialize if needed
      if ((window as any).FB && !(window as any).FB?.initDone) {
        ...
        (window as any).FB.initDone = true;
      }
      setFbSdkLoaded(true);
      return;
    }
            ...
            <div className="mt-2 space-y-1.5">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className={`w-3.5 h-3.5 rounded-[2px] flex items-center justify-center border-2 transition-all flex-shrink-0 ${
                    agreed
            ...
            <div className="mt-2 flex flex-col gap-2">
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24">
                  ...
                  <path
                    fill="#EA4335"
                    d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.0 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                  />
                </svg>
              ...
              >
                <svg className="w-4 h-4" viewBox="0 0 24 24">
                  <path
                    fill="#1877F2"
                    d="M22.675 0H1.325C.593 0 0 .593 0 1.325v21.351C0 23.406.593 24 1.325 24H12.82v-9.294H9.692V11.04h3.128V8.414c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.794.143v3.24l-1.918.001c-1.504 0-1.795.716-1.795 1.763v2.312h3.587l-.467 3.666h-3.12V24h6.116C23.407 24 24 23.406 24 22.676V1.325C24 .593 23.407 0 22.675 0z"
                  />
                </svg>
        ...
        <div className="w-full max-w-[500px] p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 font-medium text-base">
              Pick the parcel and start earning
            </p>
          </div>
