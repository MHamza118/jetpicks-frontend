...
const Settings = () => {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        setLoading(true);
        const response = await ordererProfileApi.getSettings();
        if (response.data) {
  ...
  const handleToggle = async (key: keyof typeof settings) => {
    ...
    try {
      setError('');
      setSuccess('');
      await ordererProfileApi.updateSettings({
        [key]: newValue,
      });
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative w-12 h-6 rounded-full transition-colors ${
                          settings.push_notifications_enabled ? 'bg-[#FFDF57]' : 'bg-gray-300'
                        }`}
                      >
                        <div
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative w-12 h-6 rounded-full transition-colors ${
                          settings.in_app_notifications_enabled ? 'bg-[#FFDF57]' : 'bg-gray-300'
                        }`}
                      >
                        <div
                          className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative w-12 h-6 rounded-full transition-colors ${
                          settings.message_notifications_enabled ? 'bg-[#FFDF57]' : 'bg-gray-300'
                        }`}
                      >
                        <div
                          className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative w-12 h-6 rounded-full transition-colors ${
                          settings.location_services_enabled ? 'bg-[#FFDF57]' : 'bg-gray-300'
                        }`}
                      >
                        <div
                          className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-transparent border-b-2 border-gray-300 text-gray-900 font-semibold text-sm focus:outline-none focus:border-[#FFDF57] pb-2"
                      >
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <button
                        ...
                        className={`relative w-12 h-6 rounded-full transition-colors flex-shrink-0 ml-2 ${
                          settings.auto_translate_messages ? 'bg-[#FFDF57]' : 'bg-gray-300'
                        }`}
                      >
                        <div
                          className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className={`relative w-12 h-6 rounded-full transition-colors flex-shrink-0 ml-2 ${
                          settings.show_original_and_translated ? 'bg-[#FFDF57]' : 'bg-gray-300'
                        }`}
                      >
                        <div
                          className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
